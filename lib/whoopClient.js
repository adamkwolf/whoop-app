class WhoopClient {
    ...
    async getBodyMeasurement() {
        return this.request('/v1/user/body');
    }
    ...
    async getCycles(startDate, endDate, limit = 10) {
        ...
        return this.request(`/v1/cycle?${params.toString()}`);
    }

    // Get sleep data for a specific cycle
    async getSleepForCycle(cycleId) {
        return this.request(`/v1/cycle/${cycleId}/sleep`);
    }
    ...
    async getRecovery(startDate, endDate, limit = 10) {
        ...
        return this.request(`/v1/recovery?${params.toString()}`);
    }
    ...
    async getWorkouts(startDate, endDate, limit = 10) {
        ...
        return this.request(`/v1/workout?${params.toString()}`);
    }
